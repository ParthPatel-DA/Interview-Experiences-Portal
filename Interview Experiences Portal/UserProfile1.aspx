<%@ Page Title="" Language="C#" MasterPageFile="~/MainClientMasterPage.master" AutoEventWireup="true" CodeFile="UserProfile1.aspx.cs" Inherits="UserProfile" %>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="display: inline-block;">
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="lnkSelectCompany" runat="server">
                                <asp:Image ID="Image1" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton1" runat="server">
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton2" runat="server">
                                <asp:Image ID="Image3" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton3" runat="server">
                                <asp:Image ID="Image4" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton4" runat="server">
                                <asp:Image ID="Image5" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton5" runat="server">
                                <asp:Image ID="Image6" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton6" runat="server">
                                <asp:Image ID="Image7" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton7" runat="server">
                                <asp:Image ID="Image8" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton8" runat="server">
                                <asp:Image ID="Image9" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton9" runat="server">
                                <asp:Image ID="Image10" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton10" runat="server">
                                <asp:Image ID="Image11" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton11" runat="server">
                                <asp:Image ID="Image12" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton12" runat="server">
                                <asp:Image ID="Image13" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton13" runat="server">
                                <asp:Image ID="Image14" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton14" runat="server">
                                <asp:Image ID="Image15" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton15" runat="server">
                                <asp:Image ID="Image16" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton16" runat="server">
                                <asp:Image ID="Image17" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton17" runat="server">
                                <asp:Image ID="Image18" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton18" runat="server">
                                <asp:Image ID="Image19" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
                        ...
                        <div class="col-md-3" style="padding: 20px;">
                            <asp:LinkButton ID="LinkButton19" runat="server">
                                <asp:Image ID="Image20" runat="server" ImageUrl="~/Assets/pages/img/background/34.jpg" Style="width: 100%; height: 150px;" />
