...
<!-- Mirrored from keenthemes.com/preview/metronic/theme/admin_1/form_wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Apr 2018 06:09:32 GMT -->
<!-- Added by HTTrack -->
                                                ...
                                                <ul class="nav nav-pills nav-justified steps">
                                                    ...
                                                    <li>
                                                        <a href="#tab2" data-toggle="tab" class="step">
                                                            ...
                                                            <span class="desc">
                                                                <i class="fa fa-check"></i>Experiences </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab1">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select name="cmpany_name" id="country_name" class="form-control">
                                                                    <option value="" selected disabled>Select Company name</option>
                                                                    <option value="AF">Amazon</option>
                                                                    <option value="AF">Daily hunt</option>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select name="designation" id="designation" class="form-control">
                                                                    ...
                                                                    <option value="AF">Manager</option>
                                                                    <option value="AF">Devloper</option>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="year" id="year" placeholder="Enter Year in which you give interview" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="radio-list">
                                                                    <label>
                                                                        <input type="radio" name="incampus" data-title="yes" />
                                                                        Yes
                                                                    </label>
                                                                    <label>
                                                                        <input type="radio" name="incampus" data-title="no" />No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select name="designation" id="jobtype" class="form-control">
                                                                    <option value="" selected disabled>Select Job Type</option>
                                                                    <option value="AF">i</option>
                                                                    <option value="AF">j</option>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="radio-list">
                                                                    <label>
                                                                        <input type="radio" name="inselected" data-title="yes" />
                                                                        Yes
                                                                    </label>
                                                                    <label>
                                                                        <input type="radio" name="inselected" data-title="no" />No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="year" id="ctc" placeholder=" Enter CTC you got/offered" />
                                                            ...
                                                            <div class="container">
                                                                ...
                                                                <div class="container">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <select name="no_round" id="no_round" class="form-control">
                                                                                <option selected disabled>Select no of Rounds</option>
                                                                                <option>1</option>
                                                                                <option>2</option>
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <select name="type_round" id="type_round" class="form-control">
                                                                                <option selected disabled>Select type of Rounds </option>
                                                                                <option>GD</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <select name="no_question" id="no_question" class="form-control">
                                                                                <option selected disabled>Select no of Question</option>
                                                                                <option>1</option>
                                                                                <option>2</option>
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <input type="text" class="form-control" name="question" id="question" placeholder=" Enter question ehich were ask to you" />
...
<!-- Mirrored from keenthemes.com/preview/metronic/theme/admin_1/form_wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Apr 2018 06:09:34 GMT -->
</html>
