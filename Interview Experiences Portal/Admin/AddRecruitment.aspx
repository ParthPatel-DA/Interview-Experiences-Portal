<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMainMaster.master" AutoEventWireup="true" CodeFile="AddRecruitment.aspx.cs" Inherits="AddRecruitment" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Recruitment Form</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group date">
                                ...
                                <asp:DropDownList ID="ddCompanyName" runat="server" class="form-control select2-dropdown"></asp:DropDownList>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddProgramName" runat="server" class="form-control select2-dropdown"></asp:DropDownList>
                            </div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Number Of Selected Students:</label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-group"></i>
                                </div>
                                <asp:TextBox ID="txtSelectedStudents" runat="server" class="form-control pull-right"></asp:TextBox>
                            </div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Number Of Appeared Students:</label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-group"></i>
                                </div>
                                <asp:TextBox ID="txtAppearedStudents" runat="server" class="form-control pull-right"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Year:</label>
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtYear" runat="server" class="form-control pull-right"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Package:</label>
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtPackage" runat="server" class="form-control pull-right"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddDesignation" runat="server" class="form-control pull-right"></asp:DropDownList>
                            </div>
                        </div>

                        <div class="form-group col-lg-12" style="margin-top: 20px;">
                            <div class="input-group pull-right">
                                <asp:Button ID="btnAddRecruitment" runat="server" Text="Add Recruitment" class="btn btn-flat btn-primary" OnClick="btnAddRecruitment_Click" />
                            </div>
                        </div>
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Recruitmanr List With Details</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 224px;">Batch Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 199px;">No of Students</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 156px;">Appeared Students</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 156px;">Year</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 156px;">Package</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th rowspan="1" colspan="1">Batch Name</th>
                                                    <th rowspan="1" colspan="1">No of Students</th>
                                                    <th rowspan="1" colspan="1">Appeard Students</th>
